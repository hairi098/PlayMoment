...
const clickAsset = (key: string) => {
  ...
  switch (key) {
    ...
    case "maps":
      ...
      break;
    case "rundown":
      modalRundown.value = !modalRundown.value;
      break;
    case "contact":
      modalContact.value = !modalContact.value;
      break;
    default:
      break;
  }
...
<template>
  ...
  >
    <div
      ...
      :style="{
        backgroundImage: `url(${template.bg_mobile_url})`,
        '--c-tombol': store.customColors.tombol || '#7c3aed',
        '--c-popup': store.customColors.popup || '#1a2e45',
        '--c-efek': store.customColors.efek || '#f472b6',
        '--c-text': '#1a2e45',
    ...
    >
      ...
      <div class="right-btns">
        ...
        <button
          ...
          :title="lightIsOn ? 'Matikan Lampu' : 'Nyalakan Lampu'"
        >
          <svg
            width="20"
            height="20"
      ...
      <template v-for="asset in template.assets" :key="asset.key">
        <img
          v-if="
            store.sectionStates[assetSectionKey(asset.key)]?.active !== false
          "
          :src="asset.Image_url"
      ...
      <!-- ══ NOTIFIKASI LAMPU — di dalam drawer ══ -->
      <Transition name="notif-fade">
        <div
          v-if="showLightNotif"
          class="light-notif-card"
          @click="showLightNotif = false"
        >
          <div class="light-notif-header">
            <span
              class="light-notif-icon-wrap"
              :style="{ color: store.customColors.efek || '#f472b6' }"
            >
              <svg
                width="16"
                height="16"
            ...
            <span class="light-notif-title">Efek Cahaya</span>
          </div>
          <p class="light-notif-desc">
            Klik tombol ini untuk mematikan atau menyalakan efek cahaya! ✨
          </p>
          <p class="light-notif-hint">Ketuk untuk menutup</p>
        </div>
      </Transition>

      <!-- ══ TOMBOL HAMBURGER MENU (pojok kiri atas) ══ -->
      <button
        class="hamburger-btn"
        :style="{
          ...
          <div class="ucapan-row">
            ...
            <div class="ucapan-bubble ucapan-bubble--welcome">
              ...
              <div class="ucapan-text">
                Terima kasih sudah membuka undangan kami. Semoga bisa hadir ya! 💕
              </div>
            </div>
          </div>
        </div>
      ...
      <!-- Empty state: belum ada yang ucapan -->
      <div
        v-if="!showWelcomeBubble && showUcapan && guests.length === 0"
        class="ucapan-empty-card"
      >
        <p class="ucapan-empty-text">
          Silahkan konfirmasi kehadiran dan berikan ucapan terbaik untuk kami.
        </p>
        <button
      ...
      <!-- Normal bubbles: sudah ada ucapan -->
      <div
        v-else-if="!showWelcomeBubble && showUcapan && visibleUcapan"
        class="ucapan-wrap"
      >
      ...
      <div v-if="showWelcomeModal" class="welcome-backdrop">
        ...
        >
          ...
          <div
            class="welcome-icon"
            :style="{
              background: `linear-gradient(135deg, ${store.customColors.tombol || '#7c3aed'}, ${store.customColors.efek || '#f472b6'})`,
            }"
          >
            <svg
              width="28"
          ...
          <div
            class="welcome-name"
            :style="{ color: store.customColors.tombol || '#7c3aed' }"
          >
          ...
          <div class="welcome-divider">
            <span></span><span class="welcome-diamond">◆</span><span></span>
          </div>

          <!-- Pesan singkat -->
          <p class="welcome-pesan">
    ...
    <!-- ══ MENU PANEL (auto muncul saat undangan dibuka) ══ -->
      ...
      <div v-if="showMenuPanel" class="menu-backdrop">
        ...
        >
          ...
          <div
            ...
            :style="{ background: store.customColors.popup || '#1a2e45' }"
          >
          ...
          <div
            ...
            :style="{ background: store.customColors.popup || '#1a2e45' }"
          >
            <span>Pilih menu untuk melihat informasi undangan</span>
          </div>
          ...
          <div class="menu-panel-body">
            <template v-for="asset in template.assets" :key="asset.key">
              ...
              >
                <div
                  class="menu-card-img-wrap"
                  :style="{ background: `linear-gradient(135deg, color-mix(in srgb, ${store.customColors.tombol || '#7c3aed'} 15%, white), color-mix(in srgb, ${store.customColors.efek || '#f472b6'} 10%, white))` }"
                >
            ...
            <!-- Watermark PlayMoment: logo + sosmed jadi SATU toggle (showLogoWatermark) -->
            <template v-if="(store as any).showLogoWatermark !== false">
              <!-- Hubungi & Ikuti Kami (PlayMoment) -->
              <div class="menu-social-section">
                <p class="menu-section-label">Hubungi &amp; Ikuti Kami</p>
                <div class="menu-social-row">
                  <a
                    :href="platformInfo.instagramUrl"
                    target="_blank"
                    rel="noopener noreferrer"
                    class="menu-social-btn"
                  ...
                  <a
                    :href="`https://wa.me/${platformInfo.whatsapp}`"
                    target="_blank"
                    rel="noopener noreferrer"
                    class="menu-social-btn menu-social-btn--full"
                    @click="playClickSound()"
                    @mouseenter="playHoverSound()"
                  >
    ...
    <!-- ══ SEMUA MODAL via Teleport — keluar dari overflow:hidden drawer ══ -->
    <Teleport to="body">
      <div
        class="teleport-modal-root"
        :style="{
          '--c-tombol': store.customColors.tombol || '#7c3aed',
          '--c-popup': store.customColors.popup || '#1a2e45',
          '--c-efek': store.customColors.efek || '#f472b6',
      ...
      >
        ...
        <Transition name="modal-fade">
          <div
            ...
            @click.self="closeModal(() => (modalGallery = false))"
          >
            <div class="cmodal-box">
              <div
                ...
                :style="{ background: store.customColors.popup || '#1a2e45' }"
              >
                <span class="modal-custom-header-title">{{
                  (store.sectionContents as any).galeri?.judul || "Gallery"
                }}</span>
                <button
                  class="modal-custom-close"
                  @click="closeModal(() => (modalGallery = false))"
                  @mouseenter="playHoverSound()"
                >
                  ✕
                </button>
              ...
              <div class="modal-body-inner">
                ...
                <div class="text-center mb-4">
                  <h3
                    v-if="isVisible('galeri', 'galeriJudul')"
                    class="text-base font-bold mb-1 modal-section-item-title"
                  >
                    {{
                      (store.sectionContents as any).galeri?.judul ||
                      "Galeri Foto"
                    }}
                  </h3>
                  <p
                    v-if="isVisible('galeri', 'galeriSubJudul')"
                    class="text-xs text-gray-500 italic"
                  >
                    {{
                      (store.sectionContents as any).galeri?.subJudul ||
                      "Momen indah yang kami abadikan bersama"
                    }}
                  </p>
                </div>
                ...
                <div
                  ...
                  class="columns-2 gap-2 space-y-2"
                >
                  <img
                    v-for="(img, i) in galleries"
                    :src="img.image_url"
                ...
                >
                  <img
                    ...
                    alt="foto galeri hero"
                    class="rounded-md w-full object-cover"
                    style="height: 220px"
                  />
                  <div class="grid grid-cols-2 gap-2">
                    <img
                      v-for="(img, i) in galleries.slice(1, 7)"
                      :src="img.image_url"
                      alt="foto galeri"
                      class="rounded-md w-full object-cover aspect-square"
                      :key="i"
                ...
                >
                  <div class="grid grid-cols-2 gap-2">
                    <img
                      v-for="(img, i) in galleries.slice(0, 2)"
                      :src="img.image_url"
                      :key="'5a' + i"
                      alt="foto galeri"
                      class="rounded-md w-full object-cover aspect-square"
                  ...
                  <div class="grid grid-cols-2 gap-2">
                    <img
                      v-for="(img, i) in galleries.slice(2, 4)"
                      :src="img.image_url"
                      :key="'5b' + i"
                      alt="foto galeri"
                      class="rounded-md w-full object-cover aspect-square"
        ...
        <Transition name="modal-fade">
          <div
            v-if="modalProfile"
            class="cmodal-backdrop"
            @click.self="closeModal(() => (modalProfile = false))"
          >
            <div class="cmodal-box">
              <div
                class="modal-custom-header"
              ...
              >
                <span class="modal-custom-header-title">{{
                  (store.sectionContents as any).mempelai?.judulModal ||
                  "Profil Mempelai"
                }}</span>
                <button
                  class="modal-custom-close"
                  @click="closeModal(() => (modalProfile = false))"
                  @mouseenter="playHoverSound()"
                >
                  ✕
                </button>
              ...
              <div class="modal-body-inner mp-new-body">
                ...
                >
                  <div class="mp-new-quotes-box">
                    ...
                    <p class="mp-new-quotes-source" v-if="isVisible('quotes', 'quotesSource')">
                      —
                      {{
                        (store.sectionContents as any).quotes?.source ||
                        "QS. Ar-Rum: 21"
                      }}
                    </p>
                  </div>
                ...
                <div class="mp-new-card mp-new-card--bride">
                  <div class="mp-new-card-photo-wrap" v-if="isVisible('mempelai', 'fotoBride')">
                    <img
                      :src="profiles[0].image_url"
                      alt="The Bride"
                      class="mp-new-card-photo"
                    />
                  </div>
                  <div class="mp-new-card-info">
                    <h4 class="mp-new-card-label" v-if="isVisible('mempelai', 'brideLabelSub')">{{ profiles[0].label }}</h4>
                    <h2 class="mp-new-card-name" v-if="isVisible('mempelai', 'nama1')">
                      {{ profiles[0].namaLengkap || profiles[0].name }}
                    </h2>
                    <p class="mp-new-card-bio" v-if="isVisible('mempelai', 'brideOrangTua')">
                      {{
                        profiles[0].bio || "Putri dari Bapak ... dan Ibu ..."
                      }}
                    </p>
                    <a
                      ...
                      :href="
                        profiles[0].igLink ||
                        `https://instagram.com/${profiles[0].instagram.replace('@', '')}`
                      "
                      target="_blank"
                      rel="noopener noreferrer"
                ...
                <div class="mp-new-card mp-new-card--groom">
                  ...
                  <div class="mp-new-card-info">
                    ...
                    <h2 class="mp-new-card-name" v-if="isVisible('mempelai', 'nama2')">
                      {{ profiles[1].namaLengkap || profiles[1].name }}
                    </h2>
                    <p class="mp-new-card-bio" v-if="isVisible('mempelai', 'groomOrangTua')">
                      {{
                        profiles[1].bio || "Putra dari Bapak ... dan Ibu ..."
                      }}
                    </p>
                    <a
                      ...
                      :href="
                        profiles[1].igLink ||
                        `https://instagram.com/${profiles[1].instagram.replace('@', '')}`
                      "
                      target="_blank"
                      rel="noopener noreferrer"
        ...
        <Transition name="modal-fade">
          <div
            v-if="modalEvent"
            class="cmodal-backdrop"
            @click.self="closeModal(() => (modalEvent = false))"
          >
            <div class="cmodal-box">
              <div
                class="modal-custom-header"
              ...
              >
                ...
                <button
                  class="modal-custom-close"
                  @click="closeModal(() => (modalEvent = false))"
                  @mouseenter="playHoverSound()"
                >
                  ✕
                </button>
              ...
              <div class="modal-body-inner">
                <!-- Deskripsi acara — selalu tampil -->
                <p class="text-sm text-gray-500 text-center italic mb-3" v-if="isVisible('acara', 'acaraDesc')">
                  {{
                    (store.sectionContents as any).acara?.desc ||
                    "Merupakan suatu kehormatan dan kebahagiaan bagi kami apabila Bapak/Ibu/Saudara/i berkenan hadir."
                  }}
                </p>

                <!-- Countdown Timer — selalu tampil jika showCountdown aktif -->
                <div
                  v-if="showCountdown"
                  class="countdown-wrap mb-4"
                  :style="{
                    background:
                      (store.sectionContents as any).acara?.countdownBg ||
                      'var(--c-popup, #1a2e45)',
                  }"
                >
                ...
                <div class="space-y-3">
                  ...
                  >
                    <div class="text-center mb-3">
                      <h3
                        class="text-lg font-semibold tracking-wide modal-section-item-title"
                      >
                        {{ event.name }}
                      </h3>
                    ...
                    <div class="space-y-2 text-sm text-gray-700">
                      ...
                      <div
                        ...
                        v-if="i === 0 ? isVisible('acara', 'lokasiAkad') : isVisible('acara', 'lokasiResepsi')"
                      >
        ...
        <Transition name="modal-fade">
          <div
            v-if="modalLoveStory"
            class="cmodal-backdrop"
            @click.self="closeModal(() => (modalLoveStory = false))"
          >
            <div class="cmodal-box">
              <div
                class="modal-custom-header"
              ...
              >
                <span class="modal-custom-header-title">{{
                  (store.sectionContents as any).lovestory?.judul ||
                  "Love Story"
                }}</span>
                <button
                  class="modal-custom-close"
                  @click="closeModal(() => (modalLoveStory = false))"
                  @mouseenter="playHoverSound()"
                >
                  ✕
                </button>
              ...
              <div class="modal-body-inner">
                <p class="text-sm text-gray-500 mb-4 text-center italic">
                  {{
                    ...
                    "Perjalanan cinta kami yang indah menuju hari bahagia."
                  }}
                </p>

                <!-- ── Layout: foto-atas (default) ── -->
                <div
                  v-if="loveStoryLayout === 'foto-atas'"
                  class="modal-story-timeline"
                >
                  <div
                    v-for="(story, i) in LoveStorys"
                    :key="i"
                    class="modal-story-item"
                  >
                    ...
                    <div class="modal-story-content">
                      <div class="modal-story-title">
                        {{ story.title }}
                      </div>
                      <div class="modal-story-desc">
                        {{ story.description }}
                      </div>
                    </div>
                  </div>
                ...
                <!-- ── Layout: foto-kanan ── -->
                <div
                  v-else-if="loveStoryLayout === 'foto-kanan'"
                  class="modal-story-timeline"
                >
                  <div
                    v-for="(story, i) in LoveStorys"
                    :key="i"
                    class="modal-story-item modal-story-item--row"
                  >
                    <div class="modal-story-content modal-story-content--flex">
                      <div class="modal-story-date-inline">
                        {{ story.date }}
                      </div>
                      <div class="modal-story-title">
                        {{ story.title }}
                    ...
                    <img
                      ...
                      :src="story.image_url"
                      alt="foto love story"
                      class="modal-story-img modal-story-img--side"
                    />
                  </div>
                </div>
                ...
                <!-- ── Layout: foto-kiri ── -->
                <div
                  v-else-if="loveStoryLayout === 'foto-kiri'"
                  class="modal-story-timeline"
                >
                  <div
                    v-for="(story, i) in LoveStorys"
                ...
                <!-- ── Layout: teks-klasik ── -->
                <div
                  v-else-if="loveStoryLayout === 'teks-klasik'"
                  class="modal-story-timeline"
                >
                  <div
                    v-for="(story, i) in LoveStorys"
                    :key="i"
                    class="modal-story-item modal-story-item--text"
                  >
                    <div class="modal-story-text-header">
                      <div class="modal-story-title">
                        {{ story.title }}
                      </div>
                      <span class="modal-story-date-chip">{{
                        story.date
                      }}</span>
                    </div>
                    <div class="modal-story-desc">
                ...
                <!-- ── Layout: teks-quote ── -->
                <div
                  v-else-if="loveStoryLayout === 'teks-quote'"
                  class="modal-story-timeline"
                >
                  <div
                    v-for="(story, i) in LoveStorys"
                    :key="i"
                    class="modal-story-item modal-story-item--quote"
                  >
                    <div
                      class="modal-story-quote-mark"
                      :style="{ color: store.customColors.tombol || '#7c3aed' }"
                    >
                      "
                    </div>
                    <div class="modal-story-title modal-story-title--quote">
                      {{ story.title }}
                    </div>
                    <div class="modal-story-desc modal-story-desc--quote">
                      {{ story.description }}
                    </div>
                    <div class="modal-story-quote-footer">
                      — {{ story.date }}
                    </div>
                  </div>
                </div>

                <!-- ── Layout: teks-timeline ── -->
                <div
                  v-else-if="loveStoryLayout === 'teks-timeline'"
                  class="modal-story-vtimeline"
                >
                  <div
                    v-for="(story, i) in LoveStorys"
                    :key="i"
                    class="modal-story-vt-item"
                  >
                    <div
                      class="modal-story-vt-dot"
                      :style="{
                        background: store.customColors.tombol || '#7c3aed',
                      }"
                    ></div>
                    <div
                      v-if="i < LoveStorys.length - 1"
                      class="modal-story-vt-line"
                      :style="{
                        background: store.customColors.tombol || '#7c3aed',
                      }"
                    ></div>
                    <div class="modal-story-vt-content">
                      <div
                        class="modal-story-vt-date"
                        :style="{
                          color: store.customColors.tombol || '#7c3aed',
                        }"
                      >
                        {{ story.date }}
                      </div>
                ...
                <!-- ── Fallback: sama seperti foto-atas ── -->
        ...
        <Transition name="modal-fade">
          <div
            v-if="modalRsvp"
            class="cmodal-backdrop"
            @click.self="closeModal(() => (modalRsvp = false))"
          >
            <div class="cmodal-box">
              <div
                class="modal-custom-header"
              ...
              >
                ...
                <button
                  class="modal-custom-close"
                  @click="closeModal(() => (modalRsvp = false))"
                  @mouseenter="playHoverSound()"
                >
                  ✕
                </button>
              ...
              <div class="modal-body-inner">
                ...
                <div
                  v-if="rsvpConfig.desc || rsvpConfig.batas"
                  class="mb-4 text-sm text-gray-500"
                >
                  <p v-if="rsvpConfig.desc">
                    {{ rsvpConfig.desc }}
                  </p>
                  <p v-if="rsvpConfig.batas" class="mt-1">
                    Batas konfirmasi: <strong>{{ rsvpConfig.batas }}</strong>
                  </p>
                </div>
                ...
                <div
                  v-if="rsvpSubmitted"
                  class="mb-4 bg-green-50 border border-green-200 rounded-lg p-3 text-center text-green-700 text-sm font-medium"
                >
                ...
                <form @submit.prevent="handleRsvp" class="space-y-4">
                  <!-- Nama -->
                  <UFormField
                    v-if="rsvpConfig.showNama"
                    :label="rsvpConfig.labelNama"
                    class="w-full"
                  >
                    <UInput
                      v-model="newGuest.name"
                      :required="rsvpConfig.requiredNama"
                      :readonly="rsvpConfig.readOnlyNama"
                      class="w-full"
                      :placeholder="rsvpConfig.placeholderNama"
                  ...
                  <!-- Grup -->
                  <UFormField
                    v-if="rsvpConfig.showGrup"
                    :label="rsvpConfig.labelGrup"
                    class="w-full"
                  >
                    <UInput
                      v-model="newGuest.grup"
                      :required="rsvpConfig.requiredGrup"
                      :readonly="rsvpConfig.readOnlyGrup"
                      class="w-full"
                      :placeholder="rsvpConfig.placeholderGrup"
                      @input="playTypingSound()"
                      @mouseenter="playHoverSound()"
                    />
                  </UFormField>
                  ...
                  <!-- No WhatsApp -->
                  <UFormField
                    v-if="rsvpConfig.showWhatsapp"
                    :label="rsvpConfig.labelWhatsapp"
                    class="w-full"
                  >
                    <UInput
                      v-model="newGuest.whatsapp"
                      type="tel"
                      :required="rsvpConfig.requiredWhatsapp"
                      :readonly="rsvpConfig.readOnlyWhatsapp"
                      class="w-full"
                      :placeholder="rsvpConfig.placeholderWhatsapp"
                      @input="playTypingSound()"
                      @mouseenter="playHoverSound()"
                    />
                  </UFormField>
                  ...
                  <!-- Kehadiran -->
                  <UFormField
                    v-if="rsvpConfig.showKehadiran"
                    :label="rsvpConfig.labelKehadiran"
                    class="w-full"
                  >
                    <select
                      v-model="newGuest.attendance"
                      :required="rsvpConfig.requiredKehadiran"
                      :disabled="rsvpConfig.readOnlyKehadiran"
                      class="rsvp-select w-full"
                      @change="playClickSound()"
                      @mouseenter="playHoverSound()"
                    >
                      <option value="" disabled>-- Pilih Kehadiran --</option>
                      <option
                        v-for="opt in attendanceStatus"
                        :key="opt.value"
                        :value="opt.value"
                      >
                        {{ opt.label }}
                  ...
                  <!-- Jumlah Tamu -->
                  <UFormField
                    v-if="rsvpConfig.showJumlah"
                    :label="rsvpConfig.labelJumlah"
                    class="w-full"
                  >
                    <select
                      v-model="newGuest.jumlah"
                      :required="rsvpConfig.requiredJumlah"
                      :disabled="rsvpConfig.readOnlyJumlah"
                      class="rsvp-select w-full"
                      @change="playClickSound()"
                      @mouseenter="playHoverSound()"
                    >
                  ...
                  <!-- Ucapan -->
                  <UFormField
                    v-if="rsvpConfig.showUcapan"
                    :label="rsvpConfig.labelUcapan"
                    class="w-full"
                  >
                    <UTextarea
                      v-model="newGuest.comment"
                      class="w-full mb-4"
                      :required="rsvpConfig.requiredUcapan"
                      :readonly="rsvpConfig.readOnlyUcapan"
                      :placeholder="rsvpConfig.placeholderUcapan"
                      @input="playTypingSound()"
                      @mouseenter="playHoverSound()"
                    />
                  </UFormField>
                ...
                <div class="space-y-4 mb-4">
                  <div v-for="(guest, index) in guests" :key="index">
                    <div
                      class="bg-white text-sm border border-gray-100 text-black rounded-lg p-4 shadow-sm"
                    >
                      <div class="flex items-center flex-wrap gap-1">
                        <span class="font-medium">{{ guest.name }}</span>
                        <span
                          v-if="guest.grup"
                          class="px-2 text-xs rounded-full bg-blue-100 text-blue-700"
                          >{{ guest.grup }}</span
                        >
                        <span
                          ...
                          :class="{
                            ...
                            'bg-yellow-200 text-yellow-800':
                              guest.attendance === 'Mungkin Hadir',
                      ...
                      >
                        {{ rsvpConfig.labelJumlah }}: {{ guest.jumlah }} orang
                      </div>
        ...
        <Transition name="modal-fade">
          <div
            v-if="modalGift"
            class="cmodal-backdrop"
            @click.self="closeModal(() => (modalGift = false))"
          >
            <div class="cmodal-box cmodal-box--gift">
              <div
                class="modal-custom-header"
                :style="{ background: store.customColors.popup || '#1a2e45' }"
              >
                <span class="modal-custom-header-title">{{
                  (store.sectionContents as any).gift?.judul || "Amplop Digital"
                }}</span>
                <button
                  class="modal-custom-close"
                  @click="closeModal(() => (modalGift = false))"
                  @mouseenter="playHoverSound()"
                >
                  ✕
                </button>
              ...
              <div class="modal-body-inner">
                <p class="text-sm text-gray-500 mb-4 leading-relaxed" v-if="isVisible('gift', 'giftDesc')">
                  {{
                    ...
                    "Doa restu Anda merupakan karunia yang sangat berarti bagi kami. Namun jika ingin memberikan tanda kasih, Anda dapat melalui rekening berikut."
                  }}
                </p>
                <div class="space-y-4">
                    ...
                    <div class="gift-bank-card">
                      <div class="gift-bank-top">
                        ...
                        <div class="gift-bank-chip">
                          <div
                            class="gift-chip-line gift-chip-line--h gift-chip-line--top"
                          ></div>
                          <div
                            class="gift-chip-line gift-chip-line--h gift-chip-line--bottom"
                          ></div>
                          <div
                            class="gift-chip-line gift-chip-line--h gift-chip-line--mid-left"
                          ></div>
                          <div
                            class="gift-chip-line gift-chip-line--h gift-chip-line--mid-right"
                          ></div>
                          <div
                            class="gift-chip-line gift-chip-line--v gift-chip-line--left"
                          ></div>
                          <div
                            class="gift-chip-line gift-chip-line--v gift-chip-line--right"
                          ></div>
                        </div>
                        <img
                          v-if="gift.image_url && isVisible('gift', 'logoBank')"
                          :src="gift.image_url"
                          alt="logo bank"
                          class="gift-bank-logo"
                        />
                      </div>
                      <div class="gift-bank-name" v-if="isVisible('gift', 'namaBankRekening')">{{ gift.bank }}</div>
                      <div class="gift-bank-number" v-if="isVisible('gift', 'nomorRekening')">
                        {{ gift.account_number }}
                      </div>
                      ...
                      <div class="gift-bank-holder" v-if="isVisible('gift', 'namaRekening')">
                        Atas Nama {{ gift.account_name }}
                      </div>
                    </div>
                    <!-- Tombol Konfirmasi di luar kartu -->
                    <a
                      :href="
                        gift.waMe
                          ? 'https://wa.me/' + gift.waMe.replace(/\D/g, '')
                          : '#'
                      "
        ...
        <Transition name="modal-fade">
          <div
            v-if="modalDresscode"
            class="cmodal-backdrop"
            @click.self="closeModal(() => (modalDresscode = false))"
          >
            <div class="cmodal-box">
              <div
                class="modal-custom-header"
              ...
              >
                <span class="modal-custom-header-title">{{
                  (store.sectionContents as any).dresscode?.judul ||
                  "Dress Code"
                }}</span>
                <button
                  class="modal-custom-close"
                  @click="closeModal(() => (modalDresscode = false))"
                  @mouseenter="playHoverSound()"
                >
                  ✕
                </button>
              ...
              <div class="modal-body-inner">
                <div class="bg-white text-black rounded-lg p-5">
                  <img
                    v-if="isVisible('dresscode', 'dresscodeImage')"
                    :src="dresscode.image_url"
                    alt="dresscode"
                    class="w-full h-48 object-cover rounded-md mb-4"
                  />
                  <h3 class="text-xl font-semibold mb-3" v-if="isVisible('dresscode', 'dresscodeTema')">
                    {{ dresscode.theme }}
                  </h3>
                  ...
                  <p class="text-sm text-gray-600 leading-relaxed" v-if="isVisible('dresscode', 'dresscodeDesc')">
        ...
        <Transition name="modal-fade">
          <div
            v-if="modalMaps"
            class="cmodal-backdrop"
            @click.self="closeModal(() => (modalMaps = false))"
          >
            <div class="cmodal-box">
              <div
                class="modal-custom-header"
              ...
              >
                ...
                <button
                  class="modal-custom-close"
                  @click="closeModal(() => (modalMaps = false))"
                  @mouseenter="playHoverSound()"
                >
                  ✕
                </button>
              ...
              <div class="modal-body-inner">
                <div class="bg-white text-black rounded-lg p-4">
                  <p
                    v-if="mapLocation.desc"
                    class="text-sm text-gray-500 mb-3 text-center"
                  >
                    {{ mapLocation.desc }}
                  </p>
                  <!-- Iframe dengan border dari custom color -->
                  <div
                    class="maps-iframe-wrapper"
                    :style="{
                      borderColor: 'var(--c-border)',
                    }"
                  >
                  ...
                  <!-- Nama venue & alamat di bawah, center -->
                  <div class="maps-info-center">
                    <h3 class="maps-venue-name" v-if="isVisible('maps', 'lokasiResepsi')">
                      {{ mapLocation.venue }}
                    </h3>
        ...
        <Transition name="modal-fade">
          <div
            v-if="modalRundown"
            class="cmodal-backdrop"
            @click.self="closeModal(() => (modalRundown = false))"
          >
            <div class="cmodal-box">
              <div
                class="modal-custom-header"
              ...
              >
                ...
                <button
                  class="modal-custom-close"
                  @click="closeModal(() => (modalRundown = false))"
                  @mouseenter="playHoverSound()"
                >
                  ✕
                </button>
              ...
              <div class="modal-body-inner">
                <div class="modal-rundown-wrap">
                  <p v-if="rundownData.desc" class="modal-rundown-desc">
                    {{ rundownData.desc }}
                  </p>
                  <div class="modal-timeline">
                    <div
                      v-for="(item, i) in rundownData.items"
                      :key="i"
                    ...
                    >
                      ...
                      <div class="modal-timeline-connector">
                        ...
                        <div
                          v-if="i < rundownData.items.length - 1"
                          class="modal-timeline-line"
                        ></div>
                      </div>
                      <div class="modal-timeline-right">
                        <div class="modal-timeline-activity">
                          {{ item.kegiatan }}
                        </div>
                      </div>
                    </div>
                    <div
                      v-if="!rundownData.items.length"
                      class="modal-empty-state"
                    >
                      Belum ada rundown yang ditambahkan.
                    </div>
                  </div>
                </div>
              </div>
        ...
        <Transition name="modal-fade">
          <div
            v-if="modalContact"
            class="cmodal-backdrop"
            @click.self="closeModal(() => (modalContact = false))"
          >
            <div class="cmodal-box">
              <div
                class="modal-custom-header"
              ...
              >
                <span class="modal-custom-header-title">{{
                  (store.sectionContents as any).contact?.judul ||
                  "Informasi Kontak"
                }}</span>
                <button
                  class="modal-custom-close"
                  @click="closeModal(() => (modalContact = false))"
                  @mouseenter="playHoverSound()"
                >
                  ✕
                </button>
              ...
              <div class="modal-body-inner">
                <div class="modal-contact-wrap">
                  <div class="modal-contact-avatar-wrap" v-if="isVisible('contact', 'fotoContact')">
                    <img
                      v-if="store.undangan.fotoContact"
                      :src="store.undangan.fotoContact"
                      alt="foto contact"
                      class="modal-contact-avatar"
                    />
                    <div v-else class="modal-contact-avatar-fallback">
                      ...
                      >
                        <path
                          d="M22 16.92v3a2 2 0 0 1-2.18 2 19.79 19.79 0 0 1-8.63-3.07A19.5 19.5 0 0 1 4.69 12 19.79 19.79 0 0 1 1.63 3.38 2 2 0 0 1 3.6 1.21h3a2 2 0 0 1 2 1.72c.127.96.361 1.903.7 2.81a2 2 0 0 1-.45 2.11L7.91 8.78a16 16 0 0 0 6 6l.92-.92a2 2 0 0 1 2.11-.45c.907.339 1.85.573 2.81.7A2 2 0 0 1 21.71 16.21l.21.71z"
                          stroke-linecap="round"
                          stroke-linejoin="round"
                        />
                      </svg>
                  ...
                  <div class="modal-contact-name" v-if="isVisible('contact', 'contactNama')">
                    {{
                      (store.sectionContents as any).contact?.nama ||
                      store.undangan.nama1 ||
                      "Nama Kontak"
                    }}
                  </div>
                  <div class="modal-contact-role" v-if="isVisible('contact', 'contactLabel')">
                    {{
                      (store.sectionContents as any).contact?.labelContact ||
                  ...
                  <a
                    ...
                    :href="
                      (store.sectionContents as any).contact?.wa
                        ? `https://wa.me/${((store.sectionContents as any).contact?.wa || '').replace(/\D/g, '')}`
                        : '#'
                    "
                    target="_blank"
                    rel="noopener noreferrer"
                  ...
                  >
                    ...
                    {{
                      (store.sectionContents as any).contact?.btnText ||
    ...
    <!-- ══ OPENING COVER — ukuran sama persis kayak .drawer ══ -->
    <Transition name="cover-slide">
      <div v-if="!isOpen" class="cover-wrap">
        ...
        <!-- Overlay gradasi -->
        <div
          v-if="(store.sectionContents as any).opening?.showOverlay !== false"
          class="cover-overlay"
        ></div>
        ...
        <div class="cover-content">
          ...
          <div class="cover-title-area">
            ...
            <div class="cover-judul" v-if="isVisible('opening', 'judul')">
              {{ openingData.judul }}
            </div>
            <div class="cover-line">
              <span></span><span class="cover-diamond">◆</span><span></span>
            </div>
            <!-- Nama mempelai -->
        ...
        <!-- Cover loading — bg putih + heart line, muncul 3 detik pertama -->
        ...
        <!-- Heart line transition overlay — muncul saat buka undangan -->
